...
function getPrice(destination, eventDate, nights, numPeople, currencySymbol) {
  return new Promise((resolve, reject) => {
    ...
    Promise.all([getPropertiesDetails(destination, checkInDate, checkOutDate, numPeople, currencySymbol),
    getAveragePrice(destination, checkInDate, checkOutDate, numPeople, currencySymbol)])
      .then(details => {
...
function getPropertiesDetails(destination, checkInDate, checkOutDate, numPeople, currencySymbol) {
  return new Promise((resolve, reject) => {
    ...
    types.forEach((propertyType, idx) => {
      ...
      prices.push(getAveragePrice(destination, checkInDate, checkOutDate, numPeople, currencySymbol, roomType = types[idx]));
...
function getAveragePrice(destination, checkInDate, checkOutDate, numPeople, currencySymbol, roomType) {
  return new Promise((resolve, reject) => {
